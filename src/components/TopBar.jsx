export function TopBar() {
    ...
    return <div>
            ...
            <div className="grid grid-cols-3 h-16 p-2 sm:pl-64 border-b">
                <div className="col-span-1">
                <div className="flex">
                    <div className="font-medium text-xl pl-2 pt-2">
                        Payouts
                    </div>
                            <div className="flex">
                            ...
                            <div className="pl-1 pt-4 text-xs ">
                            How it works
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-span-1">
                    <div>
                        <div class="relative ">
                            ...
                            <input type="search" id="default-search" className="block w-full  p-4 ps-10 text-sm text-gray-900   rounded-lg bg-gray-100 h-12 " placeholder="Search features, tutorials, etc." required />
                        </div>
                ...
                <div className="flex justify-end">
                    <div className="h-10 w-10 rounded-full bg-gray-200 pt-2 pl-2">
                    ...
                    <div className="h-10 w-10 rounded-full bg-gray-200 pt-4 pl-3 ml-3">
